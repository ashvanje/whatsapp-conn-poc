...
function findMtrStopsByStationCode(stationCode) {
  return mtrStops.filter(function(x){return x.stationCode == stationCode})[0]
}
...
module.exports = {
  findMtrStopsByStationCode,
  findMtrStopsByStationName
}